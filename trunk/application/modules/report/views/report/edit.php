...
<form class="form-horizontal" role="form" method="post" action="<?php echo site_url(); ?>report/report/edit/<?php
echo $data['rep_id'];
...
?>">
    <div class="toolbar col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2">
        <div class="left">
            ...
            <button  type="submit" value="submit"  name="submit"  class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-ok-circle"></i> Update</button>
         ...
         <div class="filter col-sm-10">
            <div class="form-group col-sm-4">
                ...
                <div class="input-group date col-sm-9" data-datepicker="true">
                    <input type="text" class="form-control" id="rep_sdate" placeholder="yyyy-mm-dd" name="rep_sdate"   value="<?php echo $data['rep_sdate']; ?>" >
            ...
            <div class="form-group col-sm-4">
                ...
                <div class="input-group date col-sm-9 " data-datepicker="true">
                    <input type="text" class=" form-control" id="rep_edate" placeholder="yyyy-mm-dd"  name="rep_edate" value="<?php echo $data['rep_edate']; ?>" >
                    <span class="input-group-addon add-on"><span class="glyphicon glyphicon-calendar"></span>
                    </span>
